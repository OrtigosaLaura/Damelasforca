const palavras = ["gato", "cachorro", "coelho", "elefante", "borboleta", "avestruz", "flamingo", "pantera", "galo", "galinha"];
...
function  iniciarJogo() {
    ...
    letras.forEach((value, index) => {
        botoes.innerHTML += `<button id='btn-${value}' class='btn btn-light me-1 
        mb-1' onclik='checarLetra("${value}")'>${value}</button>`;
    });
