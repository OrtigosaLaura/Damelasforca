const palavras = ["gato", "cachorro", "coelho", "elefante", "borboleta", "avestruz", "flamingo", "pantera", "gallo", "galinha"];
...
function  iniciarJogo() {
    ...
    letras.forEach((value, index) => {
        botoes.innerHTML += `<button id='btn-${value}' class='btn btn-outline-dark me-1 
        mb-1' onclick='checarLetra("${value}")'>${value}</button>`;
    });
...
function trocaLetra(textOriginal, letra, posicao){
    let listaTexto = textOriginal.split(" ");
